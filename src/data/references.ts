...
export const executiveReferences: ExecutiveReference[] = [
  ...
  },
  {
    name: "Romano Kreutz",
    initials: "RK",
    title: "Director of Culinary / Ex-Executive Chef Amari",
    organization: "IHG Hotels & Resorts",
    phone: "+66 (0) 633 258 381",
    email: "romanokreutz@aol.com",
    quote: "I had the pleasure of working with Chef Chandra during my time as Executive Chef at Amari Bangkok, and I can confidently say that he is a calm, creative, and dependable culinary professional."
  }
];
