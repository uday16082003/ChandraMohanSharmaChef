...
export const ResumeModal: React.FC<ResumeModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleDirectDownloadPDF = async () => {
    ...
    try {
      ...
      // Render as 1 clean, perfectly proportioned A4 sheet with natural spacing
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-3 sm:p-6 overflow-y-auto resume-modal-overlay">
        ...
        >
          ...
          {/* =========================================================================
              OFFSCREEN FIXED-WIDTH A4 PRINTABLE TEMPLATE (Uniform Natural Spacing)
              ========================================================================= */}
          <div
            ref={pdfTemplateRef}
            style={{
          ...
          >
            {/* Header */}
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", borderBottom: "1.5px solid #E8DFD3", paddingBottom: "16px", marginBottom: "16px" }}>
            ...
            <div style={{ marginBottom: "16px" }}>
              <h3 style={{ margin: "0 0 5px 0", fontSize: "11.5px", fontWeight: "bold", color: "#18181B", textTransform: "uppercase", letterSpacing: "0.08em" }}>
                Career Objective &amp; Leadership Vision
              </h3>
            ...
            {/* Professional Experience */}
            <div style={{ marginBottom: "16px" }}>
              <h3 style={{ margin: "0 0 8px 0", fontSize: "11.5px", fontWeight: "bold", color: "#18181B", textTransform: "uppercase", letterSpacing: "0.08em" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", paddingTop: "14px", borderTop: "1.5px solid #E8DFD3", marginBottom: "14px" }}>
              <div>
                <h3 style={{ margin: "0 0 6px 0", fontSize: "11.5px", fontWeight: "bold", color: "#18181B", textTransform: "uppercase", letterSpacing: "0.08em" }}>
                  Honors &amp; Awards
                </h3>
            ...
            {/* Executive Endorsements */}
            <div style={{ paddingTop: "12px", borderTop: "1.5px solid #E8DFD3" }}>
              <h3 style={{ margin: "0 0 4px 0", fontSize: "11.5px", fontWeight: "bold", color: "#18181B", textTransform: "uppercase", letterSpacing: "0.08em" }}>
                Executive Endorsements
              </h3>
